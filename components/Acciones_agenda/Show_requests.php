...
<?php
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo("<button type='button' class='btn btn-primary' onclick='delete_requests($row['Asunto'],$row['DNI_cliente'],$row['Nombre_cl'],$row['Telefono'],$row['Email'],$row['Hora'],$row['Fecha']')>Eliminar</button></td>");
        echo"</tr>";
    }
